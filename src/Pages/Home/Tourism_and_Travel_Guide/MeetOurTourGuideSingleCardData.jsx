...
const MeetOurTourGuideSingleCardData = ({item}) => {
    const { name, photo, email, role } = item || {};
  console.log(item);
      ...
      <div className="p-6 sm:p-12 bg-gray-900 text-gray-100">
        <div className="flex flex-col space-y-4 md:space-y-0 md:space-x-6 md:flex-row">
          ...
          <div className="flex flex-col">
            ...
            Discover unparalleled adventures with us! As your dedicated Tour Guide, I craft journeys that blend excitement with cultural richness. Explore extraordinary destinations, create lasting memories, and let's embark on a travel experience beyond the ordinary. Your next unforgettable adventure starts here!
            </p>
          </div>
        </div>
...
export default MeetOurTourGuideSingleCardData;