  ...
  return (
    <Link to={`/storyDetails/${id}`} className="text-decoration-none">
      <div className="story-card-container transition-transform hover:scale-105 hover:shadow-md">
        <div className="container w-[300px] h-[280px] shadow-2xl font-Lato flex flex-col max-w-lg p-6 mx-auto divide-y rounded-md border-gray-200">
            ...
            <div className="flex space-x-4">
              <div>
                <img
                  src={tourist_image}
                  alt=""
                  className="object-cover w-14 h-14 rounded-full dark:bg-gray-500"
                />
              </div>
              <div>
