...
const Community = () => {
  return (
    <div>
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl font-Lato md:px-24 lg:px-8 lg:py-20">
  <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
    ...
    Our skilled team of professionals is dedicated to delivering seamless experiences and ensuring your utmost satisfaction in every service aspect
    </p>
  </div>
