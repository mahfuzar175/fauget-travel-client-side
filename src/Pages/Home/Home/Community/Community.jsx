      ...
      <div className="hero min-h-screen bg-base-200">
        <div className="hero-content flex-col lg:flex-row-reverse">
          ...
          <div className="w-1/2">
            ...
            <p className="py-6">
              Explore the diverse expertise of our dedicated team, each member
              passionate about delivering enriching travel experiences. From
              seasoned guides to expert planners, our team is committed to
              turning your journey into unforgettable memories
            </p>
